function navbar() {
    return `<section class="s1">
                <div class="nav1">
                    <div class="nav11">
                        <div class="left">
                            <i class="fa-solid fa-bars" onclick="sidebarfun()"></i>
                            <div class="sidebar" id="sbar">
                                ...
                                <div class="b24 bbbb">
                                    <div class="right">
                                        ...
                                        &nbsp;
                                        &nbsp;
                                        <i class="fa-solid fa-user" onclick="On()"><span style="color: #000;" onclick="On()">  &nbsp; </span></i>
                                    </div>
                                </div>
                            </div>
                            &nbsp;
                        ...
                        <div class="mid">
                            <i class="fa-solid fa-star a1"></i>
                            &nbsp;
                            <i class="fa-solid fa-star a2"></i>
                            &nbsp;
                            <i class="fa-solid fa-star a3"></i>
                            &nbsp;
                            &nbsp;
                ...
                <div class="nav2">
                    <div class="nav22">
                        ...
                        <div class="right">
                            ...
                            &nbsp;
                            &nbsp;
                            <i class="fa-solid fa-bag-shopping" onclick="carto()"></i>
                    ...
                    <div class="nav33">
                        ...
                        <div class="b3">
                            ...
                            <div class="b33">
                                <div class="b333">
                                    <ul>
                                        <li><b>FACE</b></li>
                                        <li onclick="foundation()">Foundation</li>
                                        <li>BB & CC Cream</li>
                                        <li>Concealer</li>
                                        <li>Face Primwer</li>
                                        <li>Highliter</li>
                                        <li>Face Brushes</li>
                                        <li>Makeup Palatte</li>
                                    </ul>
                                    <ul>
                                        <li><b>EYE</b></li>
                                        <li>Eye Palettes</li>
                                    ...
                                    <ul>
                                        <li><b>NAIL MAKEUP</b></li>
                                        <li>NailPolish</li>
                                        <li>Nail Care</li>
                                        <li>Manicure & Pedicure Tools</li>
                                    </ul>
                                    <ul>
                                        <li><b>MAKEUP ACCESSORIES</b></li>
                                        <li>Tweezers and Eybrow Tools </li>
                                        <li>Makeup Reomover</li>
                                        <li>Sponges & Applicators</li>
                                        <li>Makeup Bags & Travels Cases</li>
                                    </ul>
                                    <ul>
                                        <li><b>VEGAN</b></li>
                                        <li>Eye</li>
                        ...
                        <div class="b3">
                            ...
                            <div class="b33">
                                <div class="b333">
                                    <ul>
                                        <li><b>MOISTUREIZER</b></li>
                                        <li onclick="moisturizer()">Moisturizer</li>
                                        <li>Night Cream</li>
                                    ...
                                    <ul>
                                        <li><b>TREATEMENTS & HIGH TECH TOOLS</b></li>
                                        <li>Face Serums</li>
                                        <li>Cleansing Tools</li>
                                        <li>Eye Creams & Treatements</li>
                                    </ul>
                                    <ul>
                                        <li><b>MASKS</b></li>
                                        <li>Face Masks</li>
                                    ...
                                    <ul>
                                        <li><b>Bath & Shower</b></li>
                                        <li>Body Wash & Shower Gel</li>
                                        <li>Scrub and Exfoliators</li>
                                        <li>Exfoliators</li>
                                    </ul>
                                    <ul>
                                        <li><b>BODY MOISTURIZERS</b></li>
                        ...
                        <div class="b3">
                            ...
                            <div class="b33">
                                <div class="b333">
                                    <ul>
                                        <li><b>WOMEN</b></li>
                                        <li onclick="perfume()">Perfume</li>
                                        <li>Mists and Deodorants</li>
                                    </ul>
                                    <ul>
                                        <li><b>MEN</b></li>
                                        <li>Perfume</li>
                                        <li>Body Sprays & Deodorants</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="b3">
                            ...
                            <div class="b33">
                                <div class="b333">
                                    <ul>
                                        <li><b>SHAMPOO & CONDITIONER</b></li>
                                        <li>Shampoo</li>
                                        <li>Conditioner</li>
                                    </ul>
                                    <ul>
                                        <li><b>HAIR STYLING & TREATMENT</b></li>
                        ...
                        <div class="b3">
                            ...
                            <div class="b33">
                                <div class="b333">
                                    <ul>
                                        <li><b>TOP MAKEUP BRANDS</b></li>
                                        <li>Sephora Collection</li>
                                        <li>Lancôme</li>
                                        <li>Huda Beauty</li>
                                        <li>Benefit Cosmetics</li>
                                        <li>Anastasia Beverly</li>
                                        <li>Hills</li>
                                        <li>Bobbi Brown</li>
                                        <li>Smashbox</li>
                                        <li>Estee Lauder</li>
                                    ...
                                    <ul>
                                        <li><b>TOP FRAGNENCE BRANDS</b></li>
                                        <li>Tom Ford</li>
                                        <li>Hugo Boss</li>
                                        <li>Issey Miyake</li>
                                    ...
                                    <ul>
                                        ...
                                        <li>Moroccanoil</li>
                                        <li>Tiffany & Co</li>
                                        <li>Natasha Denona</li>
                                        <li>Lancôme</li>
                                        <li>Dear Dahlia</li>
                                    </ul>
                                    <ul>
                                        <li><b>BRANDS A-Z</b></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
            ...
            <section class="login" id="loginpg" >
                <form>
                    <i class="fa-solid fa-xmark" onclick="loginOff()"></i>
                    <h1>LOGIN</h1>
                    <p class="nametext">Enter your Phone/ Email</p>
                    <input type="text" />
